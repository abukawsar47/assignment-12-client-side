    ...
    return (
        <div className='my-16'>
            <div className='text-center lg:mb-12 mb-5'>
                <h2 className='text-primary text-3xl font-bold mb-2'>Flash Deals!</h2>
                <h4 className='text-xl'>Hurry up and get 25% discount</h4>
            </div>
            <div className="hero">
                <div className="hero-content flex-col lg:flex-row p-0 gap-10">
                    <img src={wheel} className="max-w-ms rounded-lg" alt='' />
                    <div className='lg:w-1/2'>
                        <h1 className="lg:text-5xl text-2xl font-bold text-primary mb-2">Offer! Offer! Offer!</h1>
                        <h1 className="lg:text-3xl text-xl font-bold mb-4">Winter Special Offer</h1>
                        <div className=''>
